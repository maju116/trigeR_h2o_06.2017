...
# Wczytujemy dane
mnist_train <- h2o.importFile(path = "hdfs:/data/h2o/digits/mnist_train.csv", 
                                      destination_frame = "mnist_train",
                                      col.names = c("label", paste0("pixel", 1:784)),
                                      col.types=c("factor", rep("int", 784)))

mnist_test <- h2o.importFile(path = "hdfs:/data/h2o/digits/mnist_test.csv",
...
mnist_nn_final <- h2o.loadModel(paste0(getwd(),
                                       "/mnist_nn_final"))
# mnist_nn_final <- h2o.deeplearning(x = 2:785,
#                               y = "label",
#                               training_frame = mnist_train,
#                               distribution = "multinomial",
#                               model_id = "mnist_nn_final",
...
h2o.confusionMatrix(mnist_nn_final, mnist_test)
